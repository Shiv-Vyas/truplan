...
function TopHeader(){
    return(
        ...
        <Row className="rowdimensions">
            <Col style={{display:"flex", justifyContent:"center", alignItems:"center", padding:"3.5vh 5vh"}} md={6}><div style={{textAlign:"left", fontFamily:"Poppins"}}><h1 style={{ fontWeight:"bold"}}>Real Estate Measuring and Drafting Services</h1><h4 style={{color:"#ED4C67", fontWeight:"bold", marginBottom:"3vh"}}>Take your creativity to new lengths</h4><h7 style={{fontWeight:"500"}}>The as-built floorplans we create have dozens of uses including home sales, interior-designing, renovations e.t.c. Get a completely <b>free</b> custom quote for our services by contacting us now! </h7><br></br><Button className='buttonClass' href="/quote" variant="success">Free Quote</Button></div></Col>
